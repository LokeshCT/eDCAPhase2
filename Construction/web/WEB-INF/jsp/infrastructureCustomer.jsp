...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="<c:url value="/assets/js/custom/InfrastructureCustomer.js" />"></script>
</head>
		...
		<div class="content">
			<div class="content_resize">
				<div class="form" style="width: auto">
					<center style="font-size: 30px">Infrastructure Customer</center>

					<br> <br> <form:form action="#" method="post"
								commandName="customer" id="InfraStructureForm">
								...
								<table class="tableborderspacing">
									...
									<tr>
										...
										<td>Infrastructure Customer Name</td>
										<td><form:input disabled="${isDisabled}"
