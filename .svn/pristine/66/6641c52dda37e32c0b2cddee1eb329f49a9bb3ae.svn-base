...
/**
 * Description : This is a Domain class DTO which will have all the values from the database.
 * @author Rohit
 *
 */
public class SiteContactDetailsDomain {
...
/**
 * @param mobilePager the mobilePager to set
 */
